...
public interface List<T> extends Collection<T> {
     ...
     *
     * <p>The elements are evaluated in iteration order. Evaluation stops
     * as soon as a matching element is found.
     *
     * <p>If this list permits {@code null} elements, the predicate may be
     * applied to {@code null} values.
     *
     * @param condition the predicate used to test elements
